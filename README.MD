...
To download any particular (private) folder, replace the id of the root folder in project settings. All other steps will
be the same as for downloading the default Quip directory.

To change the root folder, follow the next steps:
...
- Replace mentions and document links/folder links/chat links in comments to their equivalents in Google Drive
...
If you want your private files have as much information transferred as possible, please wait until the features above
are ready.
